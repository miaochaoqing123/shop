...
class GoodsCategory(models.Model):
    ...
    it_tab = models.BooleanField(default=False, verbose_name='是否导航', help_text='是否导航')
...
class Goods(models.Model):
    ...
    goods_front_images = models.ImageField(upload_to='goods/images/', null=True, blank=True, verbose_name='封面图片')
