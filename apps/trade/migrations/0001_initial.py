# -*- coding: utf-8 -*-
# Generated by Django 1.11.7 on 2018-05-01 11:23
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pay_status', models.CharField(choices=[('success', '成功'), ('cancel', '取消'), ('cancel', '待支付')], max_length=30, verbose_name='订单状态')),
                ...
                ('signer_mobile', models.CharField(default='', max_length=20, verbose_name='联系电话')),
                ('add_time', models.DateTimeField(default=datetime.datetime.now, verbose_name='添加时间')),
            ],
            options={
                'verbose_name': '订单',
